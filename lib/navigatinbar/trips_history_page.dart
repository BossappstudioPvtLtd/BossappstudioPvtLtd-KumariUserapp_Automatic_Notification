...
class _TripsHistoryPageState extends State<TripsHistoryPage> {
  ...
  builder: (BuildContext context, snapshotData) {
    ...
    // Add each trip data to the list
    dataTrips.forEach((key, value) {
      tripsList.add({"key": key, ...value});
    });

    // Sort the list by publishDateTime in descending order
    tripsList.sort((a, b) {
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text( "Time: ${DateFormat('HH:mm:ss').format(DateTime.parse(tripsList[index]['publishDateTime']))}",
                                style: const TextStyle(
                                fontSize: 16,
                                color: Colors.grey,
                                ),
